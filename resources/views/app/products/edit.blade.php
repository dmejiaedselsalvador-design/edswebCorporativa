...
<div class="max-w-4xl mx-auto py-12 px-4">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="bg-blue-900 px-6 py-4">
            <h2 class="text-xl font-bold text-white">Edit Product: {{ $product->name }}</h2>
        </div>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6" method="POST">
            ...
            <input type="url" name="ebay_url" 
                   ...
                   value="{{ old('description', $product->ebay_url) }}"/>
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t">
                ...
                <button type="submit" class="bg-blue-900 text-white px-6 py-2 rounded hover:bg-blue-800 shadow-lg transition">Update Product</button>
            </div>
        </form>
    </div>
</div>
